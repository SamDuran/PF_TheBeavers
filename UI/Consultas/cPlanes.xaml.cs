...
namespace UI
{
    public partial class cPlanes : Window
    {
        ...
        private void Buscar()
        {
                    ...
                    case 2: //Buscar por Nombre
                        {
                            if (DesdePicker.SelectedDate != null && HastaPicker.SelectedDate != null)
                            {
                                lista = PlanesBLL.GetListExistentes(x => x.Nombre.ToLower().Contains(BusquedaTB.Text.ToLower())
                                && x.FechaCreacion <= HastaPicker.SelectedDate && x.FechaCreacion >= DesdePicker.SelectedDate);
                            }
                            else if (HastaPicker.SelectedDate != null)
                            {
                            ...
                            {
                                lista = PlanesBLL.GetListExistentes(e => e.Nombre.ToLower().Contains(BusquedaTB.Text.ToLower()));
                            }
                            break;
                        }
                }
            ...
            // if (!string.IsNullOrEmpty(TipoPlanTB.Text))
            //     lista = lista?.FindAll(c => c.TipoPlanId.ToLower().Contains(TipoPlanIdTB.Text.ToLower()));

            // if (!string.IsNullOrEmpty(AsuntoTB.Text))
            //     lista = lista?.FindAll(c => c.Estado.ToLower().Contains(AsuntoTB.Text.ToLower()));

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoAveria = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "3 Mbps/1 Mbps + 150 canales", true, new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8784), new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8785), "Combo Básico", 1000f, 1 });

            migrationBuilder.InsertData(
                table: "Planes",
                columns: new[] { "PlanId", "Descripcion", "Estado", "FechaCreacion", "FechaModificacion", "Nombre", "Precio", "TipoPlanId" },
                values: new object[] { 2, "10 Mbps/3 Mbps + 175 canales", true, new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8801), new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8802), "Combo Medio", 1700f, 2 });

            migrationBuilder.InsertData(
                table: "Planes",
                columns: new[] { "PlanId", "Descripcion", "Estado", "FechaCreacion", "FechaModificacion", "Nombre", "Precio", "TipoPlanId" },
                values: new object[] { 3, "50 Mbps/10 Mbps + 275 canales", true, new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8816), new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8816), "Combo Premium", 2850f, 3 });

            migrationBuilder.InsertData(
                table: "Planes",
                columns: new[] { "PlanId", "Descripcion", "Estado", "FechaCreacion", "FechaModificacion", "Nombre", "Precio", "TipoPlanId" },
                values: new object[] { 4, "25 Mbps/5 Mbps + 225 canales", true, new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8829), new DateTime(2022, 7, 19, 0, 10, 5, 11, DateTimeKind.Local).AddTicks(8830), "Combo Deluxe", 2500f, 3 });
